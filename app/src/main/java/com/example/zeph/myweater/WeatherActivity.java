...
public class WeatherActivity extends AppCompatActivity {
   ...
   * 处理并展示Weather实体类的数据
   */
  private void showWeatherId(Weather weather) {
  ...
  private void initAll() {
    ...
    titleUpdateTime = (TextView) findViewById(R.id.weather_update_time);
    degreeText = (TextView) findViewById(R.id.degree_txt);
    weatherInfoText = (TextView) findViewById(R.id.now_cond_txt);
